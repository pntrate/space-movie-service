...
{
    public class FetchMoviesFromImdbQueryHandler : IRequestHandler<FetchMoviesFromImdbQuery, IEnumerable<ImdbMovie>>
    {
        private readonly IImdbService _imdbService;
        private readonly IOptions<AppSettings> _appSettings;

        public FetchMoviesFromImdbQueryHandler(IImdbService imdbService, IOptions<AppSettings> appSettings)
        {
